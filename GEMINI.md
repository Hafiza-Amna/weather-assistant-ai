...
- **Groq tool calling**: Use `LiteLlm(model="groq/llama-3.3-70b-versatile")` wrapper and set `litellm.drop_params = True` to prevent Groq-unsupported parameter errors.
